    ...
    <div class="justify-between gap-x-1 gap-y-2 items-center flex-wrap mt-5">
        <div class="flex gap-1.5">
            ...
            @if (
                ...
                && $order->fulfillment_status === \Remix\OrderFlow\Enums\FulfillmentStatus::PROCESSING->value
            )
                ...
                <div class="bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <div class="flex w-full gap-2.5 justify-end mt-4 p-4">
                        ...
                        <div class="flex  flex-col gap-y-1.5">
                            ...
                            @foreach ($order->items as $item)
                                @php
                                    $base_total_due = $base_total_due - ($item->base_price * $item->qty_canceled);
                                @endphp
                            @endforeach
                            ...
                            @if (
                                ...
                                <p class="text-gray-600 dark:text-gray-300 !leading-5">
                                    {{ core()->formatBasePrice($base_total_due) }}
                                </p>
